      ...
      <View style={[styles.container, { paddingTop: safeAreaInsets.top, backgroundColor: '#fff' }]}>
        ...
        >
          ...
          <Text style={styles.completionSubtitle}>
            Rest Tremor data recorded successfully
          </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              navigation.navigate('PosturalTremor', { patient });
            }}
          >
            <Text style={styles.continueButtonText}>Continue to Postural Tremor Test</Text>
          </TouchableOpacity>
      ...
      <View style={[styles.container, { paddingTop: safeAreaInsets.top, backgroundColor: '#F9FAFB' }]}>
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.title}>Rest Tremor Test</Text>
          </View>
            ...
            <View style={styles.instructionSection}>
              ...
              <View style={styles.instructionBox}>
                <Text style={styles.instructionBoxText}>
                  "Place your hands comfortably on your lap or armrests, palms facing down. Keep your hands relaxed and completely still for 30 seconds."
                </Text>
              </View>
            </View>
