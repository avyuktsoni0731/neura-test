...
export default function PosturalTremorScreen({ navigation, route }) {
  ...
  const stopRecording = () => {
    ...
    // Access refs directly - they contain all the collected data
    const frequencyReadings = frequencyReadingsRef.current;
    const amplitudeReadings = amplitudeReadingsRef.current;

    console.log(
      'Stopping recording. Frequency readings:',
      frequencyReadings.length,
    );
    console.log('Amplitude readings:', amplitudeReadings.length);
    ...
    console.log('Calculated averages:', {
      avgFrequency,
      avgAmplitude,
      count: frequencyReadings.length,
    });
